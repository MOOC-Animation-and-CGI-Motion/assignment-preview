...
def run_tests(submission_executable, assignment, hashstr):
    ...
    for t in required_tests:
        ...
        if result is not None:
            ...
            runs.append(TestSceneRun(path=t.filepath, success=False, extra_credit=t.extra_credit, elapsed=et))
...
def print_passed(due_date, passed_runs, total_runs, extra_credit_passed=0, total_extra_credit=0):
    ...
    if total_extra_credit > 0:
        ...
        max_percentage = 100.0 + EXTRA_CREDIT_POINTS
    
    return print_passed_graded(percentage / max_percentage * 100.0, due_date, passed_runs, total_runs, extra_credit_passed, total_extra_credit)
